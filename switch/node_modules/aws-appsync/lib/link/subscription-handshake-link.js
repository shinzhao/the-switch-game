...
var SubscriptionHandshakeLink = /** @class */ (function (_super) {
    ...
    SubscriptionHandshakeLink.prototype.request = function (operation) {
        var _this = this;
        var _a = operation.getContext(), _b = this.subsInfoContextKey, subsInfo = _a[_b], _c = _a.controlMessages, _d = exports.CONTROL_EVENTS_KEY, controlEvents = (_c === void 0 ? {} : _c)[_d];
        var _e = subsInfo.extensions, _f = (_e === void 0 ? { subscription: { newSubscriptions: {}, mqttConnections: [] } } : _e).subscription, newSubscriptions = _f.newSubscriptions, mqttConnections = _f.mqttConnections, _g = subsInfo.errors, errors = _g === void 0 ? [] : _g;
                                ...
                                topics.forEach(function (t) {
                                    if (_this.topicObservers.has(t)) {
                                        _this.topicObservers.get(t).forEach(function (observer) {
                                            var _a;
                                            return observer.error(__assign({}, args, (_a = {}, _a[retry_link_1.PERMANENT_ERROR_KEY] = true, _a)));
                                        });
                                    }
                                });
                            }
