...
var newStore = function (clientGetter, persistCallback, dataIdFromObject, storage, callback) {
    ...
    var store = redux_1.createStore(redux_1.combineReducers(__assign({ rehydrated: function (state, action) {
            ...
            persistCallback();
        }, persistOptions: __assign({}, (storage && { storage: storage }), { whitelist: [
...
var offlineEffectsConfigs = [
    ...
    return (acc[enqueueAction] = __assign({ enqueueAction: enqueueAction }, rest), acc);
}, {});
