	...
	(async () => { 
		...
		let cardleft=result1.data.getQw.cardLeft
			...
			if(result1.data.getQw.whichCard!=-1){
					...
					this.cardSet[result1.data.getQw.whichCard].setScale(0.2,0.2)
					}
			if(result2.data.getQw.whichCard!=-1){
				...
				this.cardSet[result2.data.getQw.whichCard].setScale(0.2,0.2)
		 }
		 if(result3.data.getQw.whichCard!=-1){
			...
			this.cardSet[result3.data.getQw.whichCard].setScale(0.2,0.2)
	 }
	 if(result4.data.getQw.whichCard!=-1){
		...
		this.cardSet[result4.data.getQw.whichCard].setScale(0.2,0.2)
		}
